import { Home, CalendarClock, Pill, LayoutGrid, Plus, UserRound } from 'lucide-react'
...
export function AppTabBar() {
  ...
  return (
    <div className="tabbar">
      ...
      <Tab label="Labs" icon={<LayoutGrid size={22} />} active={pathname.startsWith('/app/labs')} onClick={() => navigate('/app/labs')} />
      <Tab
        label="Profile"
